...
<header>
    ...
    <div class="hero" style="background-image: linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url('asset/borobudur.jpg');">
        <div class="slogan">
            <h1 style="font-weight: bold">Your Best Destination</h1>
            <p>
                Start Your Journey!
            </p>
        </div>
    ...
    <div class="news text-center" style="background-color: #F2F2F2;">
        <h1>Destination</h1>
        <p>Discover New Experience</p>
    </div>
    <div class="destinasi">
        <?php
            $sql = "SELECT JUMLAH, ID_DESTINASI, GAMBAR, NAMA, RATING, LEFT(DESKRIPSI, 80) AS DESKRIPSI FROM DESTINASI";
